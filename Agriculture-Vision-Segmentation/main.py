...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='../Agriculture-Vision', required=False,
                        help='training directory (default: ../Agriculture-Vision')
    ...
    if os.name == 'nt':
        root_folder = pathlib.Path('../Agriculture-Vision')
        sep_path = "\\"
    else:
